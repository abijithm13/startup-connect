...
import { HiOutlineRocketLaunch, HiArrowLeft, HiEye, HiEyeSlash } from 'react-icons/hi2';
    ...
    <div className={styles.authWrapper}>
      ...
      <div className={styles.authRoleLabel}>
        ...
        <p className={styles.roleDesc}>
          Register your startup or login to manage your profile
        </p>
      </div>
        ...
        {mode === 'login' ? (
          <>
            <div className={styles.panelHeader}>
              ...
              <h2>Welcome Back</h2>
              <p>Login to access your startup dashboard</p>
            </div>
              ...
              <div className={styles.formRow}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    value={regForm.founder_name}
                    onChange={(e) =>
                      setRegForm({ ...regForm, founder_name: e.target.value })
                    }
                    required
                  />
                </div>
              ...
              <div className={styles.formRow}>
                ...
                <div className={styles.formGroup}>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setRegForm({ ...regForm, domain: e.target.value })
                    }
                    required
                  />
                </div>
